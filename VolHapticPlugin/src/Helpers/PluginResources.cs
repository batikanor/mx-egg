namespace Loupedeck.VolHapticPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.VolHapticPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.VolHapticPlugin.Resources.Resource.txt`.
